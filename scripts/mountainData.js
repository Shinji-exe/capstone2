...
// cardImage.setAttribute("src", `images/${mountain.img}`)
// })
// function getMountainsInfo(mountainSide) {
//   mountainsArray.forEach((mountain) => {
...
//   showCase.innerHTML = "";
//   for (let i = 0; i < mountainFilter.length; i++) {
//     let createElement = document.createElement("div");
